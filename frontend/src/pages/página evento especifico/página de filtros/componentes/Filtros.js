            ...
            <div className={styles.backgroundEventos}>
                ...
                <div className={styles.categoria}>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a href="/page2">Evento 1</a> 
                    </div>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 2</a> 
                    </div>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 3</a> 
                    </div>
                    <div>
                ...
                <div className={styles.categoria}>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 4</a> 
                    </div>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 5</a> 
                    </div>
                    <div className={styles.img_nome_evento} >
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 6</a> 
                    </div>
                    <div>
                        <img src={setaParaDireita} alt="" className={styles.setaDireita} />
                    </div>
                ...
                <div className={styles.categoria}>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 7</a> 
                    </div>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a hrer="/page2">Evento 8</a> 
                    </div>
                    <div className={styles.img_nome_evento}>
                        <a href="/page2"><img src={ExImgEvento} alt="" className={styles.imgEvento} /></a>
                        <a className={styles.ultimo} hrer="/page2">Evento 9</a> 
                    </div>
                    <div>
                        <img src={setaParaDireita} alt="" className={styles.setaDireita} />
                    </div>
